...
举个例子，<img height="15" src="images/equation.png"> 或者 <img height="15" src="images/equation-1.png"> 上过小学的人都能算出来（其实是背出来的)，可是，<img height="15" src="images/equation-2.png">—— 这样的时候，我们的大脑就直接宕机了 —— 别说我们普通人了，数学家的脑子也一样会宕机…… 用电子表格就简单了，无非是 `=power(2.5, 3.2)`，等于 `18.76756928`。在没有电子表格之前，我们就是束手无策啊！
